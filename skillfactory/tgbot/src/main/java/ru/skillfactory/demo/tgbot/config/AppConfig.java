package ru.skillfactory.demo.tgbot.config;
...
import ru.skillfactory.demo.tgbot.dto.GetCursOnDateXML;
import ru.skillfactory.demo.tgbot.dto.GetCursOnDateXmlResponse;
import ru.skillfactory.demo.tgbot.dto.GetCursOnDateXmlResult;
...
public class AppConfig {
    ...
    public CentralRussianBankService cbrService() throws SOAPException {
        ...
        jaxb2Marshaller.setClassesToBeBound(GetCursOnDateXML.class,
